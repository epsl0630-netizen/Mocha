...
    const eventListTitle = document.getElementById('event-list-title-index');
...
            selectDate(selectedDateElement, false);
        } else {
            const firstDateCell = calBody.querySelector('td[data-date]');
            if (firstDateCell) {
                 selectDate(firstDateCell, false);
            }
        }
        
...
     */
    function selectDate(cell, shouldOpenModal = true) {
        // ... (기존 selectDate 코드 유지) ...
        if (selectedDateElement) {
...
        		schedule_note: memo,
       		 	schedule_kind: serverKind, // ⭐️ 수정된 변수 사용
  				//user_id: user_id 
   			
            };
