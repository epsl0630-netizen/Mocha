					...
					<div class="card shadow-sm mb-3">
						<div class="card-body">
							...
							<div class="kv">
								...
								<div class="value">
									<input class="form-control" value="여름휴가" readonly>
								</div>
							</div>
							...
							<div class="kv">
								...
								<div class="value">
									<input class="form-control" value="홍길동" readonly>
								</div>
							</div>
							...
							<div class="kv">
								...
								<div class="value value-inline">
									...
									<input type="time" class="form-control input-time"
										id="startTime" value="09:00"> <span>~</span>
									...
									<input type="time" class="form-control input-time" id="endTime"
										value="18:00">
								</div>
							</div>
								...
								<div class="value value-inline">
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="scope"
											id="scopeMine" value="mine" checked> <label
											class="form-check-label" for="scopeMine">내 일정</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="scope"
											id="scopeTeam" value="team"> <label
											class="form-check-label" for="scopeTeam">팀 일정</label>
									</div>
								</div>
							</div>
							...
							<div class="kv">
								...
								<div class="value content-box">경영지원팀 주간 회의</div>
							</div>
				...
				<div class="board-actions mb-4">
					<button class="btn btn-outline-dark">
						<a href="${pageContext.request.contextPath}/schedule/scheduleList"
							class="d-block text-decoration-none py-1"> 목록 </a>
					</button>
					<button class="btn btn-outline-primary">
						<a href="${pageContext.request.contextPath}/schedule/scheduleList"
							class="d-block text-decoration-none py-1"> 수정 </a>
					</button>
					<button class="btn  btn-outline-danger ">
						<a href="${pageContext.request.contextPath}/schedule/scheduleList"
							class="d-block text-decoration-none py-1"> 확인 </a>
					</button>
				</div>
