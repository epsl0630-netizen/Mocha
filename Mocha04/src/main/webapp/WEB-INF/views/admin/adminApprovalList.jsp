...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/adminApprovalList.css"/>
<script src="${pageContext.request.contextPath}/resources/js/adminApprovalList.js"></script>
    ...
    <!-- section start -->
			<td id="section">
				<div class="container">
					...
					<!-- 결재 대기 문서 -->
					<br>
					<h4 class="mb-3">관리자 전체 문서관리</h4>

					<div class="container py-4">
						<h2 class="mb-5">문서 조회</h2>
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<div class="row mb-3 align-items-center">
									<label for="approval-form" class="col-md-2 col-form-label">결재
										종류</label>
									<div class="col-md-4">
								...
								<div class="row mb-3">
									<label for="approval-line" class="col-md-2 col-form-label">결재선</label>
									<div class="col-md-10">
										<input type="text" class="form-control" id="approval-line">
									</div>
								</div>

								<div class="row mb-3">
									<label for="doc-num" class="col-md-2 col-form-label">문서번호</label>
									<div class="col-md-10">
								...
								<div class="row mb-3">
									<label class="col-md-2 col-form-label">문서 구분</label>
									<div class="col-md-10 d-flex flex-wrap align-items-center pt-2">
										...
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												...
												class="form-check-label" for="doc-general">일반 결재문서</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="doc-receipt" value="Receipt"> <label
												class="form-check-label" for="doc-receipt">재상신 결재문서</label>
										</div>
									</div>
								</div>

								<div class="row mb-3">
									<label class="col-md-2 col-form-label">결재 상태</label>
									<div class="col-md-10 d-flex flex-wrap align-items-center pt-2">
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="status-all" value="All"> <label
												class="form-check-label" for="status-all">전체</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="status-in-progress" value="InProgress"> <label
												class="form-check-label" for="status-in-progress">진행</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="status-completed" value="Completed"> <label
												class="form-check-label" for="status-completed">승인</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="status-rejected" value="Rejected"> <label
												class="form-check-label" for="status-rejected">반려</label>
										</div>
									</div>
								</div>
							</div>
									...
									<table class="table table-hover mb-0">
										...
										<tbody>
											<tr>
												...
												<td>2025-09-17</td>
												<td>연차신청</td>
												<td><a href="approvalAddView.html" class="table-link">
														신청서 [재상신 1] </a></td>
												<td>홍길동</td>
												<td><button type="button"
														class="btn btn-outline-success">진행중</button></td>
												<td>2025.10.03 10:01</td>
											</tr>
											<tr>
												<td class="text-center"><input class="form-check-input"
													type="checkbox" name="selectDoc"></td>
