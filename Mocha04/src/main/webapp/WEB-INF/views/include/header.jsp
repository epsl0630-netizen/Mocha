		...
		<td colspan="3" id="header"><a
			...
			<div id="header-list">
				...
				<div id="notification-dropdown" class="dropdown me-3">
					<a href="#"
						class="text-decoration-none text-dark position-relative dropdown-toggle"
						data-bs-toggle="dropdown" aria-expanded="false"
						data-bs-auto-close="outside" role="button"> <i
						class="bi bi-bell-fill fs-5"></i> <span
							...
							<div class="notification-item border-bottom mb-2 pb-2">
								<div class="d-flex justify-content-between small">
									...
									<div class="d-flex align-items-center">
										<small class="text-muted me-2">4시간 전</small> <a href="#"
											class="text-dark opacity-50"
											style="font-size: 0.8rem; line-height: 1;"> <i
											class="bi bi-x-lg"></i>
										</a>
									</div>
								</div>
							</div>
							<p class="mb-1 small text-truncate">전자결재 반려 1건이 발생했습니다.
								확인바랍니다.</p>
							<div class="notification-item border-bottom mb-2 pb-2">
								<div class="d-flex justify-content-between small">
									<span class="fw-bold">게시판</span>
									<div class="d-flex align-items-center">
										<small class="text-muted me-2">어제 오후 06:00</small> <a href="#"
											class="text-dark opacity-50"
											style="font-size: 0.8rem; line-height: 1;"> <i
											class="bi bi-x-lg"></i>
										</a>
								...
								<p class="mb-1 small text-truncate text-secondary">내 게시글에
									댓글이 달렸습니다.</p>
								<a href="#additionalNotifications"
									...
									<div
										...
										<div class="notification-item-sub border-bottom pb-1 mb-1">
											<div class="d-flex justify-content-between small">
												...
												<div class="d-flex align-items-center">
													<small class="text-muted me-2">05:59</small> <a href="#"
														class="text-dark opacity-50"
														style="font-size: 0.8rem; line-height: 1;"> <i
														class="bi bi-x"></i>
													</a>
				...
				<div class="profile-nav-body">
					...
					<div class="profile-nav-btn">
						...
						<button type="button" class="btn btn-sub profile-info-close-btn"
							data-bs-toggle="modal" data-bs-target="#myinfo-modal">
							<div class="btn-icon">
