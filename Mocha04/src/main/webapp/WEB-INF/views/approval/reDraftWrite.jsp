				...
				<div class="card shadow-sm mb-3">
					<div class="card-body">
						...
						<div class="board-actions mb-4 d-flex justify-content-between">
							...
							<div>
								<a href="draftList.html" class="btn btn-outline-dark">목록</a> <a
									href="draftList.html" class="btn btn-outline-dark">취소</a> <a
									href="approvalView.html" class="btn btn-outline-dark">완료</a>
							</div>
						</div>
