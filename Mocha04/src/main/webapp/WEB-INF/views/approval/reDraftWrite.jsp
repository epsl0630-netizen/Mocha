...
<%@ include file="../include/config.jsp" %>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/approvalWirte.css" />
	<script src="${pageContext.request.contextPath}/resources/js/approvalWrite.js"></script>
<%@ include file="./approvalMenu.jsp" %>
    ...
    <div>
        <a href="approvalLinePopup.html" class="btn btn-outline-dark" 
           ...
           data-bs-target="#approvalLineModal">
            결재선추가
        </a>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="approvalLineModalLabel">결재선 추가</h5> 
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <div class="modal-body">
                <div class="p-3 rounded-3" style="background:lightblue; border: 1px; ">
                    ...
                    <div class="border rounded-3 p-3 bg-white h-100">
                      <div class="d-flex align-items-center gap-2 mb-3">
                          ...
                          <input type="text" class="form-control form-control-sm" id="treeSearch" placeholder="검색">
                      </div>
                            
                      <div class="approval-tree small approval-scroll" id="orgTreeContainer"> 
                        ...
                        <li>
                            <details open>
                                ...
                                <details open>
                                  ...
                                  <li class="d-flex align-items-center gap-2">
                                    ...
                                    data-dept="경영지원팀" data-rank="팀장" data-name="김철수">
                                    <span>김철수팀장</span>
                                  </li>
                                  <li class="d-flex align-items-center gap-2">
                                    <input type="checkbox" class="form-check-input person"
                                            data-dept="경영지원팀" data-rank="부장" data-name="오지현">
                                    <span>오지현부장</span>
                                  </li>
                                  <li class="d-flex align-items-center gap-2">
                                    <input type="checkbox" class="form-check-input person"
                                    data-dept="경영지원팀" data-rank="사원" data-name="홍길동">
                                    <span>홍길동사원</span>
                                  </li>         
                                  </ul>
                              </details>
                          ...
                          <details>
                            ...
                            <ul class="list-unstyled ps-3">
                              <li class="d-flex align-items-center gap-2">
                              <input type="checkbox" class="form-check-input person"
                              data-dept="디자인팀" data-rank="팀장" data-name="박다은">
                              <span>박다은팀장</span>
                              </li>
                            </ul>
                          </details>
      ...
      <div class="border rounded-3 p-3 bg-white h-100 d-flex flex-column"> 
        ...
        <div class="approval-scroll flex-grow-1" style="height: auto; min-height: 0; overflow-y: auto;">
