			...
			<td>
				...
				<table class="table mb-4">
					<tbody>
									...
									<div class="col-md-10 d-flex flex-wrap align-items-center">
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio"
												name="board-type" id="doc-general" value="General">
											<label class="form-check-label" for="doc-general">공지사항</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio"
												name="board-type" id="doc-receipt" value="Receipt" checked>
						...
						<tr>
							<th scope="row">제목</th>
							<td><input class="form-control" value="안녕하세요!!!!!!!!!!"
								readonly></td>
						</tr>
						...
						<tr>
							...
							<td><input type="file" id="bf-file" class="form-control"
								...
								<div id="bf-file-hint" class="form-text mt-1">파일을 여러 개 선택할
									수 있습니다.</div></td>
						</tr>
					</tbody>
				</table> <!-- 버튼 -->
				<div class="justify-content-center text-center">
					<a href="${pageContext.request.contextPath}/board/boardList"
						...
						href="${pageContext.request.contextPath}/board/boardModify"
						class="btn btn-outline-dark">수정</a> <a
