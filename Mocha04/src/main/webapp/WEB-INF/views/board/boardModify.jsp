					...
					<div class="py-3">
						...
						<div class="border rounded-3  mt-3 me-4 p-3">
							<form id="board-form" class="small" enctype="multipart/form-data">
								...
								<div class="mb-3">
									...
									<input type="text" id="bf-title" class="form-control"
								...
								<div class="mb-3">
									...
									<div class="d-flex align-items-center gap-3">
										<div class="form-check">
											<input class="form-check-input" type="radio" name="bf-board"
												id="bf-free" value="free" checked> <label
												class="form-check-label" for="bf-free">자유 게시판</label>
										</div>
										<div class="form-check">
											<input class="form-check-input" type="radio" name="bf-board"
												id="bf-notice" value="notice"> <label
								...
								<div class="mb-3">
									...
									<textarea id="bf-content" class="form-control" rows="10"
						...
						<div class="justify-content-center text-center">
							<a href="${pageContext.request.contextPath}/board/boardList"
								...
								href="${pageContext.request.contextPath}/board/boardView"
