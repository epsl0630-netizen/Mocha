				...
				<div class="gadget">
					<span class="gadget-title">캘린더</span> <a
						...
						<svg xmlns="http://www.w3.org/2000/svg" height="24px"
							viewBox="0 -960 960 960" width="15px">
							<path
							...
							<div class="card shadow-sm mb-4" id="calendar-card">
								<div
									...
									<div class="d-flex gap-2">
										...
										<button class="btn btn-primary btn-sm" id="btn-new">새
											일정</button>
									</div>
								</div>
								<div class="card-body">
										...
										<div class="modal-body">
											<div class="mb-3">
												<label class="form-label">날짜</label> <input type="date"
													class="form-control" id="event-date" required>
											</div>
											<div class="mb-3">
												<label class="form-label">제목</label> <input type="text"
													class="form-control" id="event-title" placeholder="예) 주간회의"
													required>
											</div>
			...
			<td rowspan="2" class="gadget-td gadget-side">
				<div class="gadget gadget-buttons">
					...
					<div class="quick-btn-container">
						...
						</a> <a href="../board/boardWrite.html" class="quick-btn">
							<div class="quick-icon">
								<i class="bi bi-pencil-square"></i>
							</div> <span>게시글 쓰기</span>
						</a> <a href="../schedule/scheduleWrite.html" class="quick-btn">
							<div class="quick-icon">
								<i class="bi bi-calendar-plus"></i>
							</div> <span>일정 등록</span>
						</a> <a href="../report/reportWrite.html" class="quick-btn">
							<div class="quick-icon">
				...
				<div class="gadget gadget-noti">
					<span class="gadget-title">공지사항</span> <a
						...
						class="gadget-detail-btn">더 보기 <svg
