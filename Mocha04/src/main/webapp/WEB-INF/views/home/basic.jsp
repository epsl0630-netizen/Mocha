...
<td id="menu">
	<div>
		<span class="menu-title">일정관리</span> <a href="scheduleWrite.html"
			class="btn btn-outline-light">일정등록</a> <br>
		<br>
		<ul>
			<li><a href="scheduleList.html"
				class="d-block link-light text-decoration-none py-1"> 일정목록 </a></li>
		</ul>
		<br>
		<br> <span class="menu-title">관리자 일정관리</span> <br>
		<ul>
			<li><a href="../admin/adminScheduleList.html"
				class="d-block link-light text-decoration-none py-1">전체일정관리</a></li>
		</ul>
		<br>
	</div>
</td>
